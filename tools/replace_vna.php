<?php
$c = file_get_contents('app/Views/flights/search_fixed.php');

// 1. CSS with Hover Effects
$css = "
    /* ================= VNA STYLES ================= */
...
";
$c = str_replace("font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n    }", "font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n    }\n$css", $c);

// 2. Inject function definition at top
...
// 3. Update the PHP GET block to include promo
$phpBlock = "<?php 
...
// 4. Replace flight cards and wrap in flightsListContainer safely
$replacement = '
<!-- INFO BAR -->
...
echo "Rebuilt search.php successfully with hover effects.";
