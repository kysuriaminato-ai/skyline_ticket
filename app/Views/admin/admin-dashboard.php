                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 mb-3">
                            <a href="admin-flights.php" class="btn btn-primary btn-block" style="padding: 20px; text-align: center; font-size: 1.1em;">
                                ✈️<br>Quản lý Chuyến bay
                            </a>
                        </div>
                        <div class="col-md-6 col-lg-3 mb-3">
                            <a href="admin-users.php" class="btn btn-secondary btn-block" style="padding: 20px; text-align: center; font-size: 1.1em;">
                                👥<br>Quản lý Người dùng
                            </a>
                        </div>
                        <div class="col-md-6 col-lg-3 mb-3">
                            <a href="admin-bookings.php" class="btn btn-info btn-block" style="padding: 20px; text-align: center; font-size: 1.1em;">
                                🎫<br>Quản lý Đặt chỗ
                            </a>
                        </div>
                        <div class="col-md-6 col-lg-3 mb-3">
                            <a href="admin-reports.php" class="btn btn-success btn-block" style="padding: 20px; text-align: center; font-size: 1.1em;">
                                📈<br>Báo cáo & Thống kê
                            </a>
                        </div>
                    </div>
